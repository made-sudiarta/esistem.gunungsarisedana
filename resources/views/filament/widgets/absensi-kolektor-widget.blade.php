    ...
    <x-filament::section>
        <div class="flex w-full flex-col gap-4">
           ...
           <div 
                ...
                x-data="{
                    ...
                    absenMasuk() {
                        this.ambilLokasi(function (position) {
                            Livewire.dispatch('absen-masuk-dengan-lokasi', {
                    ...
                    absenKeluar() {
                        this.ambilLokasi(function (position) {
                            Livewire.dispatch('set-lokasi-keluar', {
                                latitude: position.coords.latitude,
                                longitude: position.coords.longitude,
                            });
                        });
            ...
            <script>
                // window.ambilLokasiAbsenMasuk = function () {
                //     window.ambilLokasi(function (position) {
                //         Livewire.dispatch('absen-masuk-dengan-lokasi', {
                //             latitude: position.coords.latitude,
                //             longitude: position.coords.longitude,
                //         });
                ...
                window.ambilLokasiAbsenKeluar = function () {
                    window.ambilLokasi(function (position) {
                        Livewire.dispatch('set-lokasi-keluar', {
                            latitude: position.coords.latitude,
                            longitude: position.coords.longitude,
                ...
                window.ambilLokasi = function (callback) {
                    if (!navigator.geolocation) {
                        alert('Browser Anda tidak mendukung fitur lokasi.');
                        return;
                    }
